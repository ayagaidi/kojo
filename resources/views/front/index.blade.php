    ...
    <body style="font-family: 'Qatar2022 Arabic', sans-serif;font-size: initial;font-weight: bolder;">
                    ...
                    <div class="second-menu">
                        <div class="row align-items-center">
                            <div class="col-xl-2 col-lg-2">
                                <div class="logo">
                                    <a href="{{route('/')}}"><img src="{{asset('logoi.png')}}" alt="logo"></a>
                                </div>
                            </div>
        ...
        <main>
            ...
            <section id="home" class="slider-area fix p-relative">
				...
				<div class="single-slider slider-bg d-flex align-items-center" style="background-image: url({{asset('front/img/slider/slider_bg_01.png')}}); background-size: cover;">
                        <div class="container">
        ...
        <!-- Meal-area-end -->
            ...
            <!-- skill-area -->
            <section id="skill" class="skill-area p-relative fix" style="background: #e7eecd;">
        ...
        <footer class="footer-bg footer-p">
         <div class="footer-top  pt-90 pb-40" style="background-color: #e7eecd; background-image: url(img/bg/footer-bg.png);">
                <div class="container">
